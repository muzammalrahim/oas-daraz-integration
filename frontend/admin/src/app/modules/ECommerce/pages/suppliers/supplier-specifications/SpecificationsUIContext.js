...
export function SpecificationsUIProvider({ currentSupplierId, children }) {
  ...
  useEffect(() => {
    initSpecification.carId = currentSupplierId;
    initSpecification.supplierId = currentSupplierId;
